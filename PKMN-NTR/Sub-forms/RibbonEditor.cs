...
namespace ntrbase.Sub_forms
{
    public partial class RibbonEditor : Form
    {
        ...
        private readonly PKM pkm = Program.gCmdWindow.pkm.Clone();
            ...
            if (rib.RibbonCount >= 0) // numeric count ribbon
            {
                ...
                nud.ValueChanged += (sender, e) =>
                {
                    ...
                    if (nud.Maximum == 4)
                    {
                        ...
                        FLP_Ribbons.Controls[PrefixPB + rib.Name].BackgroundImage = (Bitmap)PKHeX.Core.Properties.Resources.ResourceManager.GetObject(n.ToLower());
                    }
                    else if (nud.Maximum == nud.Value)
                        FLP_Ribbons.Controls[PrefixPB + rib.Name].BackgroundImage = (Bitmap)PKHeX.Core.Properties.Resources.ResourceManager.GetObject(rib.Name.ToLower() + "2");
                    else
                        FLP_Ribbons.Controls[PrefixPB + rib.Name].BackgroundImage = (Bitmap)PKHeX.Core.Properties.Resources.ResourceManager.GetObject(rib.Name.ToLower());
                };
