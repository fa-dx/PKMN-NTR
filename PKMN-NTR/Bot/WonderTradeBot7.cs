            ...
            while (!botstop)
            {
                switch (botstate)
                {
                    ...
                    case (int)botstates.touchnewbox:
                        ...
                        await Task.Delay(500);
                        Program.helper.quicktouch(Program.PKTable.boxposX7[currentbox], Program.PKTable.boxposY7[currentbox], commandtime);
                        await Task.Delay(commandtime + delaytime);
                    ...
                    case (int)botstates.touchpoke:
                        ...
                        await Task.Delay(500);
                        Program.helper.quicktouch(Program.PKTable.pokeposX7[currentslot], Program.PKTable.pokeposY7[currentslot], commandtime);
                        await Task.Delay(commandtime + delaytime);
