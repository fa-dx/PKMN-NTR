...
namespace ntrbase.Bot
{
    class WonderTradeBot7
    {
        ...
        private uint FCtotalOff = 0x33124D5C;
        ...
        public static readonly uint[] pokeposY = { 70, 70, 70, 70, 70, 70, 100, 100, 100, 100, 100, 100, 130, 130, 130, 130, 130, 130, 160, 160, 160, 160, 160, 160, 190, 190, 190, 190, 190, 190 };
        public static readonly uint[] boxposX = { 35, 70, 105, 140, 175, 210, 245, 280, 35, 70, 105, 140, 175, 210, 245, 280, 35, 70, 105, 140, 175, 210, 245, 280, 35, 70, 105, 140, 175, 210, 245, 280 };
        public static readonly uint[] boxposY = { 40, 40, 40, 40, 40, 40, 40, 40, 80, 80, 80, 80, 80, 80, 80, 80, 120, 120, 120, 120, 120, 120, 120, 120, 160, 160, 160, 160, 160, 160, 160, 160 };
        #region FCtable
        ...
        public WonderTradeBot7(int StartBox, int StartSlot, int Amount, bool FCaftertrade, decimal FCtotal)
        {
            ...
            currentFC = Convert.ToUInt32(FCtotal);
        }
                ...
                switch (botstate)
                {
                    case (int)botstates.startbot:
                        ...
                        if (collectFC)
                        {
                            ...
                            Report("Collect FC activated\r\nTotal FC: " + currentFC + "\r\nCurrent level: " + level + "\r\nCoins for next level: " + (nextFC - currentFC));
                        }
                    ...
                    case (int)botstates.presstradebutton:
                        ...
                        Program.helper.quicktouch(200, 120, commandtime);
                    ...
                    case (int)botstates.pressWTbutton:
                        Report("Press Trade Button");
                        await Task.Delay(500);
                        Program.helper.quicktouch(160, 160, commandtime);
                        await Task.Delay(commandtime + delaytime);
                    ...
                    case (int)botstates.touchboxview:
                        ...
                        await Task.Delay(500);
                        Program.helper.quicktouch(140, 230, commandtime);
                        await Task.Delay(commandtime + delaytime);
                    ...
                    case (int)botstates.testboxesout:
                        ...
                        if (taskresultbool)
                        {
                            attempts = -90; // Try 100 button presses
                    ...
                    case (int)botstates.collectFC2:
                        Report("Continue dialog (Thanks for...)");
                    ...
                    case (int)botstates.collectFC3:
                        Report("Continue dialog (You received 2 FC...)");
                        await Task.Delay(500);
                        Program.helper.quickbuton(keyB, commandtime);
                        await Task.Delay(commandtime + delaytime);
                    ...
                    case (int)botstates.collectFC4:
                        Report("Continue dialog (You've collected...)");
                        await Task.Delay(500);
                        Program.helper.quickbuton(keyB, commandtime);
                        await Task.Delay(commandtime + delaytime);
